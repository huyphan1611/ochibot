...
const { getListTFT, addPlayerTFT, removePlayerTFT, listtft } = require("../../commands/tools/listtft");
...
module.exports = {
    ...
    async execute(reaction, user) {
        ...
        const player = listtft.find(item => item.messageId === message.id) || listtft.find(item => item.messageId === message.id);
